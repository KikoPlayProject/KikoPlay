...
public:
    ...
    enum class Columns
    {
        STATUS, TITLE, PROGRESS, SIZE, DOWNSPEED, TIMELEFT, UPSPEED, CONNECTION, SEEDER, DIR, CREATETIME, FINISHTIME
    };
...
private:
    ...
    QString getTaskId(const QString &url, bool extractInfoHash);
signals:
