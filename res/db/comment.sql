...
"User"  TEXT,
"Text"  TEXT,
CONSTRAINT "PoolID" FOREIGN KEY ("PoolID") REFERENCES "pool" ("PoolID") ON DELETE CASCADE
);
CREATE INDEX "PoolID_0"
ON "danmu_0" ("PoolID" ASC);
